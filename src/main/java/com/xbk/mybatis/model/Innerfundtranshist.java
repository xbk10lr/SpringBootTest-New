...
public class Innerfundtranshist extends InnerfundtranshistKey {
    ...
    private String devdeptnbr;

    private String delayaccflag;

    private Date checkdate;

    private Date othercorecleardate;
    ...
    public String getDevdeptnbr() {
        return devdeptnbr;
    }

    public void setDevdeptnbr(String devdeptnbr) {
        this.devdeptnbr = devdeptnbr;
    }

    public String getDelayaccflag() {
        return delayaccflag;
    }

    public void setDelayaccflag(String delayaccflag) {
        this.delayaccflag = delayaccflag;
    }
    ...
    public Date getOthercorecleardate() {
        return othercorecleardate;
    }

    public void setOthercorecleardate(Date othercorecleardate) {
        this.othercorecleardate = othercorecleardate;
    }
}