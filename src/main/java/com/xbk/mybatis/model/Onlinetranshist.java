...
public class Onlinetranshist {
    ...
    public BigDecimal getConfirmedcount() {
        return confirmedcount;
    }

    public void setConfirmedcount(BigDecimal confirmedcount) {
    ...
    public String getMernbrextend() {
        return mernbrextend;
    }

    public void setMernbrextend(String mernbrextend) {
        this.mernbrextend = mernbrextend;
    }
}